      ...
      try {
        ...
        if (response.ok) {
          ...
          try {
            ...
            logStep('Failed to log SMS to database', { phone, error: insertError });
          }
        } else {
          failCount++;
          ...
          try {
            ...
            logStep('Failed to log SMS failure to database', { phone, error: insertError });
          }
        }
      } catch (error: any) {
        failCount++;
        ...
        try {
          ...
          logStep('Failed to log SMS error to database', { phone, error: insertError });
        }
      }
    }
