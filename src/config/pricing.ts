...
export const FISHERMAN_PLANS = {
  STANDARD: {
    ...
    stripePriceId: 'price_1SddZqH0VhS1yyE0Zx6yVfwJ', // LIVE price ID
    smsQuotaMonthly: 50,
    openingBonusSms: 200,
    crmContacts: 500,
    salePoints: 1,
  ...
  PRO: {
    ...
    period: 'year' as const,
    stripePriceId: 'price_1Sdnn9H0VhS1yyE0JAINCVDH', // LIVE price ID
    smsQuotaMonthly: 200,
  ...
  ELITE: {
    ...
    stripePriceId: 'price_1SddbuH0VhS1yyE0ZFYhsoQ4', // LIVE price ID
...
export const SMS_PACKS = {
  PACK_500: {
    ...
    stripePriceId: 'price_1SfEWXH0VhS1yyE0OmXygkqR', // LIVE price ID
  },
  PACK_LANCEMENT: {
    id: 'pack_lancement',
    quantity: 1000,
    ...
    stripePriceId: 'price_1SfEWYH0VhS1yyE08IPly0M5', // LIVE price ID
    recommended: true,
  },
  PACK_2000: {
    id: 'pack_2000',
    ...
    stripePriceId: 'price_1SfEWZH0VhS1yyE08ZMrSWI8', // LIVE price ID
  },
  PACK_5000: {
    id: 'pack_5000',
    quantity: 5000,
    ...
    stripePriceId: 'price_1SfEWaH0VhS1yyE0c51EBSe2', // LIVE price ID
  },
} as const;
...
export const PREMIUM_PLANS = {
  ...
  PREMIUM: {
    ...
    stripePriceIdAnnual: 'price_1SZ48UH0VhS1yyE0iYmXen3H', // LIVE price ID
  ...
  PREMIUM_PLUS: {
    ...
    stripePriceIdAnnual: 'price_1SZ49DH0VhS1yyE06HJyLC65', // LIVE price ID
